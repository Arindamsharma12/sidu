...
const MessagesScreen = () => {
  ...
  const sendMessage = () => {
    if (newMessage.trim() && selectedConversation) {
      ...
      Alert.alert(
        "Message Sent!",
        `Your message has been send to ${selectedConversation.user.name}`
      );
    }
  };
  ...
  return (
    <SafeAreaView className="flex-1 bg-black" edges={["top"]}>
      ...
      <View className="flex-row items-center justify-between px-4 py-3 border-b border-gray-700">
        <Text className="text-xl font-bold text-gray-100">Messages</Text>
        <TouchableOpacity>
      ...
      >
        {conversationList.map((conversation) => (
          <TouchableOpacity
            key={conversation.id}
            className="flex-row items-center p-4 border-b border-gray-700 active:bg-gray-50"
        ...
        {selectedConversation && (
          <SafeAreaView className="flex-1 bg-black">
            ...
            <View className="flex-row items-center px-4 py-3 border-b border-gray-700">
              ...
              <View className="flex-1">
                <View className="flex-row items-center">
                  <Text className="font-semibold text-gray-300 mr-1">
            ...
            <View className="flex-row items-center px-4 py-3 border-t border-gray-700">
              <View className="flex-1 flex-row items-center bg-gray-800 rounded-full px-4 py-3 mr-3">
                <TextInput
              ...
              <TouchableOpacity
                ...
                className={`size-10 rounded-full items-center justify-center ${
                  newMessage.trim() ? "bg-blue-500" : "bg-gray-800"
                }`}
